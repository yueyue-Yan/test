...
<body>
请输入您想要查询的年份<input id="year" type="text">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#Btn1").click(function () {
            ...
            //2. 配置图标对象，指定图表的配置项和数据
            var option = {
                // ----  标题 -----
                title: {
                    text: $("#year").val()+'年市场活动每月成本统计图',
                    textStyle: {
                        color: 'red'
                    },
                    subtext: '市场活动成本统计柱状图',
            ...
            //3. 来个Ajax请求，由后端给出结果，填充图表对象
            $.ajax({
                url: "/chart/activity/getStageCount.json?year="+$("#year").val(),
                success: function (data) {
                    //option的series属性的第一个对象的data属性就是我的data
